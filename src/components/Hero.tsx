  ...
  return (
    <section ref={ref} id="home" className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0">
        {/* Base gradient */}
        <div className="absolute inset-0 bg-gradient-to-br from-brand-bg via-brand-bg to-black" />

        {/* Animated gradient orbs */}
        <motion.div
          className="absolute -top-32 -left-32 h-96 w-96 rounded-full bg-brand-red/20 blur-3xl"
          animate={{
            scale: [1, 1.3, 1],
            opacity: [0.3, 0.5, 0.3],
          }}
        ...
        />
        <motion.div
          className="absolute -bottom-32 -right-32 h-96 w-96 rounded-full bg-brand-blue/20 blur-3xl"
          animate={{
            scale: [1.3, 1, 1.3],
            opacity: [0.2, 0.4, 0.2],
          }}
      ...
      >
        {/* Glowing badge */}
        <motion.div
          className="mb-8 inline-flex items-center gap-2 rounded-full border border-brand-red/30 bg-brand-red/10 px-4 py-2"
        ...
        >
          ...
          <span className="text-sm font-medium text-brand-red">DROP 01 NOW LIVE</span>
        </motion.div>
        ...
        >
          ...
          <div className="h-12 w-px bg-white/10" />
          <div>
            <p className="font-display text-3xl text-brand-red">Rs. 89</p>
