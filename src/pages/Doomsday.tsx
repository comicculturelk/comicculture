...
// Confirmed against Supabase: products.collection = 'Doomsday'
const COLLECTION_NAME = 'Doomsday';
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <p className="mt-4 text-lg text-muted max-w-2xl mx-auto">
            A new ComicCulture arc inspired by the Doomsday era — our own fan-made take on
            worlds colliding, reimagined through original streetwear designs.
          </p>
        </motion.div>
